...
import { IconHome2, IconPencilHeart, IconKeyboard, IconClipboardCheck, IconShoppingBag, IconUserCircle, IconPlanet } from '@tabler/icons-react'
...
export default function BottomNav() {
  return (
    <nav className="bottom-nav seven">
