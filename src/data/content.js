...
export const typingSentences = [
  ...
  'I want to use English more naturally in my daily life.',
  'One useful sentence can help me write many new ideas.',
  'When I review feedback, I can improve my next diary.',
  'I am learning how to express simple thoughts clearly.',
  'A short sentence is still meaningful when I write it every day.',
  'I like to practice English because it helps me feel more confident.',
  'Could you please explain this expression one more time?',
  'I am trying to build a better study routine these days.',
  'At first, I felt nervous, but later I became more comfortable.',
  'The most memorable part of my day was a small conversation.',
]
...
export const shopItems = [
  ...
  { id: 'violet_ribbon', name: 'Violet Ribbon', emoji: '🎀', price: 140, type: 'Hat', rarity: 'Common', minLevel: 1, desc: '커멧 머리 위에 얹는 작은 보라 리본.' },
  { id: 'tiny_saturn_hat', name: 'Tiny Saturn Hat', emoji: '🪐', price: 240, type: 'Hat', rarity: 'Epic', minLevel: 16, desc: '작은 토성 모양의 우주 모자.' },
  { id: 'meteor_crown', name: 'Meteor Crown', emoji: '☄️', price: 680, type: 'Hat', rarity: 'Mythic', minLevel: 75, desc: '유성 조각으로 만든 최고 등급 왕관.' },
  { id: 'sparkle_cheeks', name: 'Sparkle Cheeks', emoji: '✨', price: 110, type: 'Face', rarity: 'Common', minLevel: 1, desc: '볼 위에 반짝이는 작은 별빛.' },
  { id: 'focus_glasses', name: 'Focus Glasses', emoji: '🧐', price: 190, type: 'Face', rarity: 'Rare', minLevel: 14, desc: '집중하는 영어 학습자를 위한 안경.' },
  { id: 'dreamy_face', name: 'Dreamy Face', emoji: '😊', price: 230, type: 'Face', rarity: 'Epic', minLevel: 24, desc: '부드러운 꿈빛 표정.' },
  { id: 'mint_cardigan', name: 'Mint Cardigan', emoji: '🧥', price: 210, type: 'Outfit', rarity: 'Rare', minLevel: 6, desc: '민트 테마와 잘 어울리는 가디건.' },
  { id: 'exam_hoodie', name: 'Exam Hoodie', emoji: '👕', price: 260, type: 'Outfit', rarity: 'Rare', minLevel: 15, desc: '시험 준비생 느낌의 편한 후디.' },
  { id: 'galaxy_uniform', name: 'Galaxy Uniform', emoji: '🎽', price: 480, type: 'Outfit', rarity: 'Legendary', minLevel: 42, desc: '은하 탐험대 유니폼.' },
  { id: 'royal_orbit_cape', name: 'Royal Orbit Cape', emoji: '🦸', price: 760, type: 'Outfit', rarity: 'Mythic', minLevel: 78, desc: '행성 궤도가 수놓인 전설 망토.' },
  { id: 'mint_tail', name: 'Mint Tail', emoji: '💚', price: 180, type: 'Tail', rarity: 'Rare', minLevel: 8, desc: '차분하게 빛나는 민트 꼬리.' },
  { id: 'rose_tail', name: 'Rose Tail', emoji: '💗', price: 220, type: 'Tail', rarity: 'Rare', minLevel: 15, desc: '따뜻한 장미빛 꼬리.' },
  { id: 'thunder_tail', name: 'Thunder Tail', emoji: '⚡', price: 540, type: 'Tail', rarity: 'Legendary', minLevel: 45, desc: '번개처럼 빠르게 빛나는 꼬리.' },
  { id: 'legendary_prism_tail', name: 'Prism Tail', emoji: '🌈', price: 980, type: 'Tail', rarity: 'Mythic', minLevel: 90, desc: '프리즘처럼 여러 색으로 갈라지는 전설 꼬리.' },
  { id: 'pencil_wand', name: 'Pencil Wand', emoji: '✏️', price: 120, type: 'Hand', rarity: 'Common', minLevel: 1, desc: '영어 문장을 만들어내는 연필 지팡이.' },
  { id: 'template_book', name: 'Template Book', emoji: '📘', price: 260, type: 'Hand', rarity: 'Rare', minLevel: 12, desc: '문장 패턴을 담아두는 작은 책.' },
  { id: 'starlight_lantern', name: 'Starlight Lantern', emoji: '🏮', price: 420, type: 'Hand', rarity: 'Epic', minLevel: 32, desc: '피드백 문장을 밝혀주는 별빛 랜턴.' },
  { id: 'deep_space_bg', name: 'Deep Space', emoji: '🌌', price: 360, type: 'Background', rarity: 'Epic', minLevel: 20, desc: '깊은 우주 배경.' },
  { id: 'cozy_desk_bg', name: 'Cozy Desk', emoji: '🪑', price: 280, type: 'Background', rarity: 'Rare', minLevel: 10, desc: '일기 쓰기 좋은 따뜻한 책상 배경.' },
  { id: 'aurora_station_bg', name: 'Aurora Station', emoji: '🌠', price: 720, type: 'Background', rarity: 'Legendary', minLevel: 55, desc: '오로라가 흐르는 우주 정거장.' },
  { id: 'tiny_satellite_pet', name: 'Tiny Satellite', emoji: '🛰️', price: 300, type: 'Pet', rarity: 'Rare', minLevel: 10, desc: '커멧 주변을 도는 작은 위성.' },
  { id: 'memo_moth', name: 'Memo Moth', emoji: '🦋', price: 340, type: 'Pet', rarity: 'Epic', minLevel: 22, desc: '문장 보관함을 좋아하는 메모 나비.' },
  { id: 'nebula_fox', name: 'Nebula Fox', emoji: '🦊', price: 640, type: 'Pet', rarity: 'Legendary', minLevel: 52, desc: '성운 사이를 달리는 작은 여우.' },
  { id: 'quiet_study_aura', name: 'Quiet Study Aura', emoji: '🫧', price: 280, type: 'Aura', rarity: 'Rare', minLevel: 10, desc: '차분한 공부 분위기를 만드는 오라.' },
  { id: 'meteor_shower_aura', name: 'Meteor Shower Aura', emoji: '🌠', price: 620, type: 'Aura', rarity: 'Legendary', minLevel: 48, desc: '주변에 유성우가 흐르는 오라.' },
  { id: 'mentor_frame', name: 'Mentor Frame', emoji: '🧭', price: 360, type: 'Frame', rarity: 'Epic', minLevel: 24, desc: '성장 방향을 보여주는 프로필 프레임.' },
  { id: 'cometail_party_frame', name: 'Cometail Party Frame', emoji: '🎊', price: 9999, type: 'Frame', rarity: 'Teacher Special', minLevel: 1, desc: '오프라인 파티 참여자 전용 프레임.' },
  { id: 'star_bridge', name: 'Star Bridge', emoji: '🌉', price: 620, type: 'Planet', rarity: 'Legendary', minLevel: 50, desc: '내 행성에 작은 별빛 다리를 놓아요.' },
  { id: 'pattern_library', name: 'Pattern Library', emoji: '🏛️', price: 700, type: 'Room', rarity: 'Legendary', minLevel: 45, desc: '문장 패턴을 보관하는 행성 도서관.' },
  { id: 'visitor_signpost', name: 'Visitor Signpost', emoji: '🪧', price: 260, type: 'Room', rarity: 'Rare', minLevel: 20, desc: '친구들이 방문할 때 보이는 작은 표지판.' },
]
...
export const sampleUser = {
  ...
  savedPatterns: [
    { id: 'p1', pattern: 'I like to ~ every day.', meaning: '나는 매일 ~하는 것을 좋아한다', example: 'I like to read a short paragraph every day.', visibility: 'public' },
    { id: 'p2', pattern: 'At first, I felt ~, but later I realized ~.', meaning: '처음에는 ~했지만 나중에 ~라는 걸 깨달았다', example: 'At first, I felt nervous, but later I realized I could do it.', visibility: 'public' },
  ],
