...
export default function TypingPage() {
  ...
  return (
    <div className="typing-page page-stack">
      <div className="page-header"><div><p className="eyebrow">Typing Practice</p><h1>영어 타자 연습</h1><p>오늘 {todayTypingCount}번 완료했어요. 다음 완료 보상은 +{nextReward} Starlight예요.</p></div><div className="point-chip large"><IconSparkles size={18} /> {user.points} Starlight</div></div>
      ...
      <div className="stats-row"><div className="stat-card"><p>WPM</p><strong>{stats.wpm}</strong></div><div className="stat-card"><p>Accuracy</p><strong>{stats.accuracy}%</strong></div><div className="stat-card"><p>Time</p><strong>{elapsed}s</strong></div><div className="stat-card"><p>Next reward</p><strong>+{nextReward}</strong></div></div>
